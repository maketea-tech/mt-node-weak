 ...
 */
  ...
  {
    if (!info[0]->IsObject())
      return Nan::ThrowTypeError("Object expected");
  ...
  bool isWeakRef(Local<Value> val)
  {
    ...
    return obj->InternalFieldCount() == FIELD_COUNT && Nan::GetInternalFieldPointer(obj, FIELD_INDEX_IDENT) == IDENT_VALUE;
  }
